...
async def get_vamt_data():
    ...
    async with httpx.AsyncClient(timeout=15.0) as client:
        # Pulls service_type, remaining, and key_id from your table
    ...
    if query.data == "main_menu":
        ...
        try:
            ...
            for item in data:
                ...
                # This pulls the actual license key from your key_id column
                ...
                # FORMATTING:
                # The key is on its own line in <code> tags for easy mobile copying.
...
def webhook():
    if request.method == 'GET':
        return "🍃 Clyde's Resource Hub is online.", 200
    try:
        ...
        async def process():
            ...
            if update.message and update.message.text in ["/start"]:
                await send_welcome_message(update.effective_chat.id, update.effective_user.first_name)
