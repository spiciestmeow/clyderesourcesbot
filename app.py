...
# --- NEW FUNCTION FOR STATIC ID MESSAGE ---
...
async def handle_callback(update: Update):
    ...
    if query.data in ["show_main_menu", "main_menu"]:
        ...
        await asyncio.sleep(0.8); try: await query.message.delete()
        except: pass
        ...
        await asyncio.sleep(1.0); await send_full_menu(update.effective_chat.id, update.effective_user.first_name)
    ...
    # (Existing callbacks logic remains the same)
    ...
    async def process_update():
        ...
        if update.message and update.message.text:
            ...
            if text.startswith("/start"):
                ...
                await send_myid(chat_id) # NO user_id needed anymore
